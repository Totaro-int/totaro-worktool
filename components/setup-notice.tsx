...
export function SetupNotice(): JSX.Element {
  return (
    <div className="w-full max-w-lg rounded-2xl bg-white p-8 shadow-sm ring-1 ring-slate-200">
      <h1 className="text-lg font-semibold text-slate-900">초기 설정이 필요합니다</h1>
      ...
      <ol className="mt-4 list-decimal space-y-2 pl-5 text-sm text-slate-700">
        ...
        <li>
          SQL Editor 에{' '}
          <code className="rounded bg-slate-100 px-1 py-0.5 text-xs">supabase/schema.sql</code>{' '}
          내용을 붙여넣고 실행합니다.
        </li>
        <li>Project Settings → API 에서 URL 과 anon key 를 복사합니다.</li>
        <li>
          프로젝트 루트에{' '}
          <code className="rounded bg-slate-100 px-1 py-0.5 text-xs">.env.local</code> 파일을 만들어
          값을 채웁니다.
        </li>
        <li>개발 서버를 다시 시작합니다.</li>
      </ol>
      <p className="mt-4 text-xs text-slate-400">자세한 안내는 README.md 를 참고하세요.</p>
    </div>
  )
}
